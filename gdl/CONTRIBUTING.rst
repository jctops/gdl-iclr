...
Welcome to ``gdl`` contributor's guide.
...
If you experience bugs or general issues with ``gdl``, please have a look
...
You can help improve ``gdl`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``gdl`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``gdl``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/gdl.git
    cd gdl
...
#. Install |pre-commit|_::
   ...
   ``gdl`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/gdl
.. _issue tracker: https://github.com/<USERNAME>/gdl/issues
.. <-- end -->
