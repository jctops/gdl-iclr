...
Welcome to ``digl`` contributor's guide.
...
If you experience bugs or general issues with ``digl``, please have a look
...
You can help improve ``digl`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``digl`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``digl``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/digl.git
    cd digl
...
#. Install |pre-commit|_::
   ...
   ``digl`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/digl
.. _issue tracker: https://github.com/<USERNAME>/digl/issues
.. <-- end -->
